...
ignore_tag = 'hefengxian_ps,hefengxian_pk'
    ...
    for group_ind in range(num_group):
        ...
        for object_prediction in prediction_result.object_prediction_list:
            if object_prediction:  # if not empty
                if object_prediction.get_shifted_object_prediction().category.name not in 'hefengxian_ps' and object_prediction.get_shifted_object_prediction().category.name not in 'hefengxian_pk':
